 ...
 * generated in the com.excelonline.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessOrder_QNAME = new QName("http://ws.excelonline.com/", "processOrder");
    private final static QName _Order_QNAME = new QName("http://ws.excelonline.com/", "Order");
    private final static QName _ProcessOrderResponse_QNAME = new QName("http://ws.excelonline.com/", "processOrderResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.excelonline.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.excelonline.com/", name = "processOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.excelonline.com/", name = "Order")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.excelonline.com/", name = "processOrderResponse")
